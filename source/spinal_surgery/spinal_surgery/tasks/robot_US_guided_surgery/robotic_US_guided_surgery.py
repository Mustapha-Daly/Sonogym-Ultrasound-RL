...
# Pre-defined configs
##
from spinal_surgery.assets.kuka_US import *scene_cfg
...
class roboticUSGuidedSurgeryEnv(DirectRLEnv):
    ...
    def __init__(
        ...
        self.pose_diff_ik_controller = DifferentialIKController(
            pose_diff_ik_cfg, self.scene_cfgene.num_envs, device=self.sim.device
        )
    ...
    def _get_observations(self) -> dict:
        ...
        #ultrasound / CT / segmentation image generation
